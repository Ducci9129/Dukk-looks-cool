...
export default function Lesson({ info }) {
  ...
  return (<>
    <Metatags title={info.title} description="Learn how to make your site interactive with [boring]"/>
    <main id={styles.page}>
...
export async function getServerSideProps({ params }) {
  const req = await fetch(`https://boring.samalander.dev/lessons/${params.id}.json`);
